...
#ifndef PARALLAX_ANDROID_CONTENT_PM_APPLICATIONINFO_H
#define PARALLAX_ANDROID_CONTENT_PM_APPLICATIONINFO_H
...
#endif //PARALLAX_ANDROID_CONTENT_PM_APPLICATIONINFO_H
