...
#ifndef PARALLAX_DEX_FILE_H
#define PARALLAX_DEX_FILE_H
...
namespace parallax {
    ...
    public:
        ...
        static size_t readFields(uint8_t *data, parallax::dex::ClassDataField *fields, uint64_t count);
        static size_t readMethods(uint8_t *data, parallax::dex::ClassDataMethod *method, uint64_t count);
